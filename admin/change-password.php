...
?>
    ...
    <body class="scroll">
        ...
        <div class="dash">
            <div class="dash-head">
                <h1>Change <span>admin password</span></h1>
            </div>
            <div class="dash-cont">
                <form class="add-vehicle-form" action="" method="post" enctype="multipart/form-data" class="form-horizontal" name="changepassword" onsubmit="return checkpass();">
                    <?php
                    $adminid = $_SESSION['vpmsaid'];
